...
cancel_cases_animation = function(){
  ...
  $('#tree4').css({ opacity: 0})
  $('#tree5').css({ opacity: 0})
  $('#ball_1').css({ opacity: 0})
  $('#ball_plus_1').css({ opacity: 0})
  $('#ball_2').css({ opacity: 0})
  $('#ball_plus_2').css({ opacity: 0})
  $('#ball_3').css({ opacity: 0})
  $('#ball_plus_3').css({ opacity: 0})
  $('#ball_4').css({ opacity: 0})
  $('#view_button').css({opacity: 0})
